...
`EventLibrary.AzureServiceBus` provides an Azure Service Bus backed implementation of `IEventHub`.

It keeps the same core eventing contract as `EventLibrary`, but publishes events to Azure Service Bus instead of dispatching them to in-process listeners.
...
- [EventLibrary README](../EventLibrary/README.md)
